  ...
  return (
    <div className="container max-w-4xl mx-auto p-4 sm:p-6">
      <div className="bg-white rounded-xl shadow-lg p-6 sm:p-8">
        <h1 className="text-3xl sm:text-4xl font-bold text-center text-slate-800 mb-6">
          Suno Tag Explorer
        </h1>
                  ...
                  <label className="flex items-center cursor-pointer group">
                    ...
                    <div className="ml-3 flex-1">
                      ...
                      <div className="text-xs text-slate-500 mt-0.5">
                        {selectedCategories.length} of {uniqueCategories.length}{" "}
                        selected
                      </div>
                    </div>
                  </label>
        ...
        <div className="border border-slate-200 rounded-lg overflow-hidden">
          <ul className="divide-y divide-slate-200">
            {displayedTags.length > 0 ? (
              ...
              <li className="p-4 text-center text-slate-500">No tags found.</li>
            )}
          </ul>
        </div>
      </div>
